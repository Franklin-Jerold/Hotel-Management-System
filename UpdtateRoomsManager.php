...
{	
    ...
    $sql_query = "UPDATE addrooms set room_no='$update',availability='$availability',status='$status' where room_no='$update' ";
...
<body>
    ...
    <div class="container">
        ...
        <div class="col-md-1 form">
                ...
                <input type="number" class="form-control" id="roomnum" name="roomnum"  required value=<?php echo "'$Room_no'";?> disabled>
            </div>
            ...
            <div class="col-3 form" id=pricer>
                ...
                <input type="number" class="form-control" id="price" placeholder="$" name="price" required value=<?php echo "'$Price'";?> disabled>
            </div>
            
            <div class="col-md-3 form">
                <label class="form-label">Bed Type</label>
                <select id="bedtype" class="form-select" name="bedtype" required disabled>
